...
export default function Apply() {
  const props = usePage().props as { pet?: string | null };
  ...
  const handleStartApplication = () => {
    ...
    router.post('/apply/start', { pet_id: petId });
  };
      ...
      <div className="content-wrapper py-20">
        <div className="max-w-2xl mx-auto bg-card rounded-xl border p-8">
          ...
          <div className="flex gap-2">
            ...
            <Button onClick={handleStartApplication} disabled={!petId}>Start Application</Button>
          </div>
        </div>
      </div>
    </AppLayout>
